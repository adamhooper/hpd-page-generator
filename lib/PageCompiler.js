...
const escapeAttr = require('marko/runtime/html/escape').escapeXmlAttr
...
class Renderer {
  ...
  renderEntry(pageEntry, href, model) {
    ...
    case 'redirect':
      const html = `<!doctype html><head><meta charset="utf-8"><title>Redirect</title></head><body>You are being <a href="${escapeAttr(href)}">redirected</a>...</body></html>`
